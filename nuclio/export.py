...
# # nuclio: ignore
has_ignore = re.compile(r'#\s*(nuclio|mlrun):\s*ignore[ ]*(?P<name>\S*)').search
has_start = re.compile(r'#\s*(nuclio|mlrun):\s*start-code[ ]*(?P<name>\S*)').search
has_end = re.compile(r'#\s*(nuclio|mlrun):\s*end-code[ ]*(?P<name>\S*)').search
